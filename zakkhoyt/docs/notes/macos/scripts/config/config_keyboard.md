...
# Disable opt+letter typing unicode chars
* [SO](https://stackoverflow.com/a/16019737/9096525)


* Save the key mapping file (below) `no_opt_binding.keylayout`.
...
# no_opt_binding.keylayout
Save this as "$HOME/Library/Keyboard Layouts/no_opt_binding.keylayout"
...
<keyboard group="0" id="11682" name="x_layout" maxout="2">
    <layouts>
    ...
    <modifierMap id="f4" defaultIndex="3">
